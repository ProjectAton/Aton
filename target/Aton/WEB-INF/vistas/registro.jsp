...
<link rel="stylesheet"
	href="<c:url value='/static/css/skins/_all-skins.min.css'/>">
<!-- iCheck -->
<link rel="stylesheet"
	href="<c:url value='/static/iCheck/flat/blue.css'/>">
<!-- Morris chart -->
<link rel="stylesheet" href="<c:url value='/static/morris/morris.css'/>">
<!-- jvectormap -->
<link rel="stylesheet"
	href="<c:url value='/static/jvectormap/jquery-jvectormap-1.2.2.css'/>">
<!-- Date Picker -->
<link rel="stylesheet"
	href="<c:url value='/static/datepicker/datepicker3.css'/>">
<!-- Daterange picker -->
<link rel="stylesheet"
	href="<c:url value='/static/daterangepicker/daterangepicker-bs3.css'/>">
<!-- bootstrap wysihtml5 - text editor -->
<link rel="stylesheet"
	href="<c:url value='/static/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css'/>">
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		<header class="main-header">
			<!-- Logo -->
			<a href="/equipos" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
					...
					<ul class="nav navbar-nav">
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img src="<c:url value='/static/img/user2-160x160.jpg' />"
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="<c:url value='/static/img/user4-128x128.jpg'/> "
														class="img-circle" alt="User Image">
												</div>
												<h4>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="<c:url value='/static/img/user2-160x160.jpg'/> "
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="/equipos"><i class="fa fa-circle-o"></i>
									Dashboard v1</a></li>
								...
								<div class="box-body">
									<div class="form-group">
										...
										<span class="has-error">
											<form:errors path="mac" class="control-label" for="mac"></form:errors>
										</span>
										<form:input path="mac" type="text" class="form-control"
											id="mac" placeholder="MAC (XX:XX:XX:XX:XX:XX)" />
									</div>
									<div class="form-group">
										<label for="ip">Ingresa dirección IP</label>
										<span class="has-error">
											<form:errors path="ip" class="control-label" for="ip"></form:errors>
										</span>
										<form:input path="ip" type="text" class="form-control"
											placeholder="IP (X.X.X.X)" />
									</div>
									<div class="form-group">
										<label for="descripcion">Ingresa una descripción del
											equipo</label>
	...
	<!-- jQuery 2.1.4 -->
	<script src="<c:url value='/static/jQuery/jQuery-2.1.4.min.js'/> "></script>
	<!-- Bootstrap 3.3.5 -->
	<script src="<c:url value='/static/js/bootstrap.min.js'/> "></script>
	<!-- FastClick -->
	<script src="<c:url value='/static/fastclick/fastclick.min.js'/> "></script>
	<!-- AdminLTE App -->
