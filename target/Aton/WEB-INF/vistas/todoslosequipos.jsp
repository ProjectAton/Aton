													...
													<div
														...
														<div class="btn-group" role="group">
															...
															<ul class="dropdown-menu">
																...
																<li><a class="flaticon-update"
																	href="<c:url value='/enviar-orden-${equipo.ip}' />">
																		Enviar una orden</a></li>
																<li><a class="flaticon-power107"
																	href="<c:url value='/apagar-${equipo.ip}' />">
																		Apagar</a></li>
																<li><a class="flaticon-update26"
																	href="<c:url value='/reiniciar-${equipo.ip}' />">
																		Reiniciar</a></li>
																<li><a
																	href="<c:url value='/actualizar-${equipo.ip}' />"
																	class="flaticon-update"> Actualizar software</a></li>
																<li role="separator" class="divider"></li>
																<li><a
																	href="<c:url value='/enviar-mensaje-${equipo.ip}' />"
																	class="flaticon-chat51"> Enviar mensaje</a></li>
																<li role="separator" class="divider"></li>
																<li><a
																	href="<c:url value='/eliminar-equipo-${equipo.ip}' />"
																	class="flaticon-delete96"> Eliminar equipo</a></li>
																<li><a
																	href="<c:url value='/editar-equipo-${equipo.ip}' />"
																	class="flaticon-delete96"> Editar equipo</a></li>
															</ul>
														</div>
													</div>
