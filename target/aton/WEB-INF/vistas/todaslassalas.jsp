				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
									...
									<tbody>
										<c:forEach items="${salas}" var="sala">
											<tr>
												...
												<td>${sala.enseres}</td>
												<td><a href="<c:url value='/admin/editar-sala-${sala.id}'/>">Editar</a></td>
												<td><a href="<c:url value='/admin/eliminar-sala-${sala.id}'/>">Eliminar</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
						...
						<div class="btn-agregar-tabla">
							<a href="<c:url value='/admin/agregar-sala' />"
