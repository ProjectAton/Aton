...
<link rel="stylesheet"
	href="<c:url value='/static/estilos/login.css' />">
...
<script src="<c:url value='/static/login/prefixfree.min.js' />"></script>
...
<body>
	...
	<div class="wrapper">
		...
		<form name='loginForm' action="${loginUrl}" method='POST'
			...
			<input type="text" placeholder="Username" name='username' id='username' autofocus
				required /> <i class="fa fa-user"></i> <input type="password"
				placeholder="Password" name='password' id='password' required /> <i
	...
	<script src="<c:url value='/static/scripts/login2.css' />"></script>
