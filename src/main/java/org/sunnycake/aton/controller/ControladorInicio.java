...
public class ControladorInicio {
     ...
     */
    private final Logger logger = LogManager.getLogger(ControladorInicio.class.getName());
    ...
    /**
     * Vista de salas. Obtiene una lista con todas las salas y las despliega a
     * través de la vista de salas.
     *
     * @param model
     * @return
     */
     ...
     * válido desde Spring
     *
     * @param equipo Empleado a validar y guardar
     * @param resultado Resultado de la validación del empleado (Válido o no
     * válido con explicación)
     * @param model Modelo con los atributos de la vista a retornar
     ...
     *
     * @param ip Identificador del equipo
     * @param model
     * @return
     */
     ...
     *
     * @param equipo Equipo construido desde el formulario.
     * @param resultado Información de la validación
     * @param model Modelo con los atributos de la vista a retornar
     * @param ip Ip del equipo a editar en la base de datos.
